...
# This lets Kubernetes service accounts assume AWS IAM roles.
...
# --- EBS CSI Driver ---
# Required in EKS 1.23+ for dynamic EBS volume provisioning (PVCs).
# The driver needs its own IAM role to create/attach/delete EBS volumes.
